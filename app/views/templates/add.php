        ...
        <form id="form" action="" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
            ...
            <?php }else{ ?>
                ...
                <div class="form-group <?php if ((!empty($this->error)) && array_key_exists('type', $this->error)) { echo 'has-error'; }?>" id = "room-group_1">
                    ...
                    <a data-toggle="tooltip" id= "add-items_1" title="Add More Items" class="btn btn-effect-ripple btn-sm btn-success add-items" data-id="1"><i class="fa fa-plus"></i></a>
                ...
                <div class="form-group">
                    <a class="btn btn-block btn-info" id="template-add-room" data-id="2"><i class="fa fa-plus"></i> Add Another Room</a>
                </div>
