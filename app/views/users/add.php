    ...
    <div class ="container">
        ...
        <form class="full" action="" method="post" enctype="multipart/form-data">
            <div class = "form-wrapper">
                ...
                <div class = "row">
                    <div class="form-group col-sm-6 right-border <?php if ((!empty($this->missing)) && in_array('password_again', $this->missing)) { echo 'error'; }?>">
...
<!--                    </select>                -->
<!--                </div>-->
                <input type="hidden" name="type" value="<?php echo $this->stored_data['type']?>">
