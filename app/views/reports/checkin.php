                                    ...
                                    <div class = "row">
                                        ...
                                        <div class = "form-group col-sm-6">
                                            <?php if(isset($item['lord_image']) && !empty($item['lord_image'])){?>
                                                ...
                                                <a href="/reports/download/<?php echo $item['id'];?>/lord_item" class="btn btn-primary check-in-download">Download Item Image <i class="fa fa-cloud-download"></i></a>
                                            <?php } else {?>
