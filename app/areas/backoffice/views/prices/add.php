...
<div id="page-content">
            ...
            <div class="col-sm-6 hidden-xs">
                <div class="header-section">
                    <ul class="breadcrumb breadcrumb-top">
                        <li><a href="/backoffice/prices/index">Prices</a></li>
    ...
    <div class="block">
        ...
        <div class="block-title">
            <h2><?php if(isset($this->stored_data['id'])){echo "Edit"; }else{ echo "Add";}?> Prices</h2>
        </div>
...
<!--                <div class="col-md-5">-->
<!--                    <a href = "/prices/" title="View Page" class = "btn btn-effect-ripple btn-sm btn-primary" target="_blank"> View Page</a>-->
<!--                </div>-->
<!--            </div>-->
                    ...
                    <div class="col-md-10 double-input">
                        ...
                        <div class="col-xs-6">
                            <div class="edit-download-wrap">
                                <a href="/backoffice/prices/download/<?php echo $this->stored_data['id'];?>/" class="btn btn-primary">Download Current Image <i class="fa fa-cloud-download"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
