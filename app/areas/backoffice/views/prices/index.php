    	...
    	<div class="block-title">
            ...
            <div class="block-options pull-right">
	    		 <div id="esearch" class="dataTables_filter">
		    		<form class="form-wrap" method='get' action='/backoffice/prices/index'>
	        ...
	        <div class="dataTables_wrapper form-inline no-footer">
			       ...
			       <div class="col-xs-12">
				        <div class="pull-right">
                            <?php if($this->countData[0]['total'] == 0) {?>
                                <a href="/backoffice/prices/add" class="btn btn-success"><i class="fa fa-plus"></i> Add Prices</a>
                            <?php } ?>
                        </div>
					</div>
				</div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if (isset($data['image']) && !empty($data['image'])){?>
                                                <img src="/assets/uploads/<?php echo $data['image']?>" alt="<?php echo $data['image']?>" style = "width:64px;">
                                            <?php }?>
                                        </td>
                                        <td class="text-left">
                                            <a href="/backoffice/prices/edit/<?php echo $data['id']; ?>/" data-toggle="tooltip" title="Edit Prices" class="btn btn-effect-ripple btn-sm btn-success"><i class="fa fa-pencil"></i></a>
                                            <a href="/backoffice/prices/delete/<?php echo $data['id']; ?>/" data-toggle="tooltip" title="Delete Prices" class="btn btn-effect-ripple btn-sm btn-danger"><i class="fa fa-times"></i></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
	            ...
	            <?php }else{ ?>
		             <div class="row no-result">
			            <div class="col-xs-12">
							<p>There are no Prices to display.</p>
			            </div>
		            </div>
			    <?php } ?>
