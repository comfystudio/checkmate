    	...
    	<div class="block-title">
            ...
            <div class="block-options pull-right">
	    		 <div id="esearch" class="dataTables_filter">
		    		<form class="form-wrap" method='get' action='/backoffice/properties/index'>
                            ...
                            <tbody>
                                <?php foreach($this->getAllData as $data) {?>
                                    <tr>
                                        ...
                                        <td class="text-left">
                                            <a href="/backoffice/properties/view/<?php echo $data['id']; ?>/" data-toggle="tooltip" title="View Property" class="btn btn-effect-ripple btn-sm btn-primary"><i class="fa fa-desktop"></i></a>
                                            <a href="/backoffice/properties/edit/<?php echo $data['id']; ?>/" data-toggle="tooltip" title="Edit Property" class="btn btn-effect-ripple btn-sm btn-success"><i class="fa fa-pencil"></i></a>
                                            <a href="/backoffice/properties/delete/<?php echo $data['id']; ?>/" data-toggle="tooltip" title="Delete Property" class="btn btn-effect-ripple btn-sm btn-danger"><i class="fa fa-times"></i></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
