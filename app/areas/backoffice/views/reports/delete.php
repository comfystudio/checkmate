...
<div id="page-content">
    ...
    <div class="block">
        ...
        <div class="block-title">
            <h2>Delete '<?php echo $this->selectedData[0]['property_title']; ?>'</h2>
        </div>
		...
		<div class="alert alert-danger alert-dismissable">
            ...
            <?php if(isset($this->conflict) && !empty($this->conflict)){?>
                <p>Can't remove this report as it is part of an ongoing check-in check-out process</p>
            <?php } else {?>
                <p>Please note that this will remove this Report. You can add them again at a later time.</p>
           <?php } ?>
	    </div>
		<form action="" method="post" class="form-horizontal form-bordered">
			...
			<div class="form-group">
                <div class="col-md-9">
                    <p class="form-control-static">You are removing: <strong><?php echo $this->selectedData[0]['property_title']; ?></strong></p>
                </div>
            </div>
